# DEPRECATED PERSONA COMPAT: military_logistics
...
2. Load domain knowledge from:       references/military_logistics_v2.md (or references/custom/military_logistics_v2.md)
