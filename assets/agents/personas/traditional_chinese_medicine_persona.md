# DEPRECATED PERSONA COMPAT: traditional_chinese_medicine
...
2. Load domain knowledge from:       references/traditional_chinese_medicine_v2.md (or references/custom/traditional_chinese_medicine_v2.md)
