# DEPRECATED PERSONA COMPAT: religious_studies
...
2. Load domain knowledge from:       references/religious_studies_v2.md (or references/custom/religious_studies_v2.md)
