# DEPRECATED PERSONA COMPAT: behavioral_economics
...
2. Load domain knowledge from:       references/behavioral_economics_v2.md (or references/custom/behavioral_economics_v2.md)
