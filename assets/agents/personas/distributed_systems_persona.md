# DEPRECATED PERSONA COMPAT: distributed_systems
...
2. Load domain knowledge from:       references/distributed_systems_v2.md (or references/custom/distributed_systems_v2.md)
