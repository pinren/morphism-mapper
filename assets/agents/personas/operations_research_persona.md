# DEPRECATED PERSONA COMPAT: operations_research
...
2. Load domain knowledge from:       references/operations_research_v2.md (or references/custom/operations_research_v2.md)
