# DEPRECATED PERSONA COMPAT: organizational_behavior
...
2. Load domain knowledge from:       references/organizational_behavior_v2.md (or references/custom/organizational_behavior_v2.md)
