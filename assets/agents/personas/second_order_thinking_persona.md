# DEPRECATED PERSONA COMPAT: second_order_thinking
...
2. Load domain knowledge from:       references/second_order_thinking_v2.md (or references/custom/second_order_thinking_v2.md)
