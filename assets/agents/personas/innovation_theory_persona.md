# DEPRECATED PERSONA COMPAT: innovation_theory
...
2. Load domain knowledge from:       references/innovation_theory_v2.md (or references/custom/innovation_theory_v2.md)
