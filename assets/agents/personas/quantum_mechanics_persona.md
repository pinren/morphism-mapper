# DEPRECATED PERSONA COMPAT: quantum_mechanics
...
2. Load domain knowledge from:       references/quantum_mechanics_v2.md (or references/custom/quantum_mechanics_v2.md)
