# DEPRECATED PERSONA COMPAT: information_theory
...
2. Load domain knowledge from:       references/information_theory_v2.md (or references/custom/information_theory_v2.md)
