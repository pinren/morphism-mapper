# DEPRECATED PERSONA COMPAT: political_science
...
2. Load domain knowledge from:       references/political_science_v2.md (or references/custom/political_science_v2.md)
