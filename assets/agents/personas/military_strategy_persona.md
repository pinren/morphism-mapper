# DEPRECATED PERSONA COMPAT: military_strategy
...
2. Load domain knowledge from:       references/military_strategy_v2.md (or references/custom/military_strategy_v2.md)
