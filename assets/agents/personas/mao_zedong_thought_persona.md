# DEPRECATED PERSONA COMPAT: mao_zedong_thought
...
2. Load domain knowledge from:       references/mao_zedong_thought_v2.md (or references/custom/mao_zedong_thought_v2.md)
