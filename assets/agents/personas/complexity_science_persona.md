# DEPRECATED PERSONA COMPAT: complexity_science
...
2. Load domain knowledge from:       references/complexity_science_v2.md (or references/custom/complexity_science_v2.md)
